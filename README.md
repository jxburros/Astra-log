...
- **Suggested Responses** — quick-response buttons appear only when the AI asks a direct question, and are dynamically generated by the AI to match likely short answers for that specific question
